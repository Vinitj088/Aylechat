        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              ...
              className="px-2 sm:px-3 text-muted-foreground hover:text-foreground hover:bg-accent group h-8 rounded-[var(--radius)] transition-all duration-300 ease-in-out overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
